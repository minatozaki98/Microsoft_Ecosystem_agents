...
When Azure requirements are incomplete, the Azure provisioning role should ask the user back and forth, one question at a time, and maintain a requirements ledger before previewing or creating resources.
